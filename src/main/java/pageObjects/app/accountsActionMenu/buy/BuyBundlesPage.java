...
public class BuyBundlesPage {

    protected AndroidDriver driver;

    private static final Logger log = LoggerFactory.getLogger(BuyAirtimePage.class);

    public BuyBundlesPage(AndroidDriver driver) {
        this.driver = driver;
        PageFactory.initElements(new AppiumFieldDecorator(driver, Duration.ofSeconds(10)), this);
    }

    @AndroidFindBy(xpath = "//android.widget.TextView[@resource-id=\"za.co.neolabs.bankzero:id/list_text\" and @text=\"Bundles\"]")
    ...
    public void  addBundleItem(String name,String provider,String product,String cellNumber)
    {
        ...
        bundlesButton.click();
        log.info("Bundles button clicked...");

        AppiumUtils.waitForTextToAppear(By.id("za.co.neolabs.bankzero:id/toolbar_title"),"Add Bundles item",driver);
        log.info("Add Bundles page displayed...");
    ...
    {
        AppiumUtils.waitForTextToAppear(By.id("za.co.neolabs.bankzero:id/toolbar_title"),"Buy Bundles",driver);
        confirmtButtn.click();
        log.info("Buy or Submit button has been clicked");
    }

    public void buyBundles(String amount, String ref)
    {
        AppiumUtils.waitForTextToAppear(By.id("za.co.neolabs.bankzero:id/toolbar_title"),"Quick Buy",driver);
    ...
    public void buyBundlesAgain(String name,String amount, String ref)
    {
        ...
        try {
            for (WebElement group : groupNames) {
                if (group.getText().equals("Bundles")) {
                    ...
                    log.warn("Bundles group name not found!");
                }
            }
        } catch (Exception e) {
