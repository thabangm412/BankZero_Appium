...
public class StatementsAndLettersFrom45DaysNoticeTests extends BaseTestsConfig {

    private static final Logger log = LoggerFactory.getLogger(StatementsAndLettersFrom45DaysNoticeTests.class);
