...
public class WithdrawalFrom32DaysNoticeTests extends BaseTestsConfig {
    ...
    @Test
    public void withdrawalFrom32DaysNotice() {
        ...
        softAssert.assertEquals(withdrawalPage.getTransactionMessage(),withdrawalPage.getExpectedAvailabilityMessage(32));
        softAssert.assertAll();
        attachScreenshot(DriverManager.driver, "Withdrawal from 32 Days Notice");
        withdrawalPage.clickFinishButton();
        homePage.clickLogoutButtn();
    }

    @Test(priority = 1)
    public void immediateWithdrawalFrom32DaysNotice()
    {
        loginPage.loginWithRetry(
                data.getUser().getProfileName(),
                data.getUser().getLoginPin(),
        ...
        softAssert.assertAll();
        attachScreenshot(DriverManager.driver, "Immediate Withdrawal from 32 Days Notice");
        withdrawalPage.clickFinishButton();
        homePage.clickLogoutButtn();
    }
}
