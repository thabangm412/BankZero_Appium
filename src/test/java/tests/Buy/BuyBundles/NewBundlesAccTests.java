...
public class NewBundlesAccTests extends BaseTestsConfig {

    private static final Logger log = LoggerFactory.getLogger(NewBundlesAccTests.class);

    @Test(dataProvider = "getMultipleDataSet")
    public void newBundlesAccTest(HashMap<String, String> input) throws IOException {
        ...
        String bundlesProduct = input.get("productBundle");
        ...
        buyBundlesPage.addAccButton();
        buyBundlesPage.addBundleItem(name,provider,bundlesProduct,recipient);
        buyBundlesPage.buyBundles(amount,ref);
