...
public class SavingsAccountRegistrationTest extends BaseTestsConfig {

    private static final Logger log = LoggerFactory.getLogger(SavingsAccountRegistrationTest.class);
    ...
    public void newSavingsAccountRegistration(HashMap<String, String> input) throws IOException {
