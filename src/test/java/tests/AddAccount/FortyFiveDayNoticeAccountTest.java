...
public class FortyFiveDayNoticeAccountTest extends BaseTestsConfig {


    private static final Logger log = LoggerFactory.getLogger(FortyFiveDayNoticeAccountTest.class);

    @Test(dataProvider = "getMultipleDataSet")
    public void newFortyFiveDayAccountRegistration(HashMap<String, String> input) throws IOException {
