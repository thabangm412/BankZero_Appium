...
public class CheckAccountRegistrationTest extends BaseTestsConfig {


    private static final Logger log = LoggerFactory.getLogger(CheckAccountRegistrationTest.class);
