...
public class SevenDayNoticeAccountTest extends BaseTestsConfig {
    ...
    public void newSevenDayAccountRegistration(HashMap<String, String> input) throws IOException {
