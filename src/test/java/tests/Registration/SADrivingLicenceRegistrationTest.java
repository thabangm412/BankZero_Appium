...
public class SADrivingLicenceRegistrationTest extends BaseTestsConfig {

    private static final Logger log = LoggerFactory.getLogger(SADrivingLicenceRegistrationTest.class);
...
//        log.info("Login page displayed.");
        ...
        try {
            Assert.assertEquals(status, "Happy?");
